...
def get_args():
    ...
    parser.add_argument('--depth-mode', action='store_true', help='Set Flag if model with depth head shall be evaluated')
...
def eval_single(
    ...
    if params.get("trt"):
        ...
        ey = EdgeYOLO(weights=params.get("weights"), depth_mode=params.get("depth_mode"))
        model = ey.model
