...
class EdgeyoloTfliteIr(InferenceRunner):
        ...
        def run_single_inference(self, image) -> DetectionImage:
            ...
            dets = self.multiclass_nms_class_agnostic(boxes_xyxy, scores, nms_thr=0.45, score_thr=0.004)
            if dets is not None:
            ...
            for idx, bbox in enumerate(final_boxes):
                detection_image.bounding_boxes.append(BoundingBox(bbox[0], bbox[1], bbox[2], bbox[3], final_scores[idx],
